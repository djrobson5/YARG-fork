...
namespace YARG.Gameplay.Player
{
    ...
    public class SixFretGuitarPlayer : FiveFretGuitarPlayer
    {
        ...
        // The Star Power path optimizer only models the five-fret highway, so the overlay stays
        // off here rather than inheriting a plan solved against the wrong note track.
        protected override bool SupportsStarPowerPath => false;
